...
> The data types include in the dataset are doubles, characters, and dates. They contain integers, strings, and time stamps. 
...
# Scatterplot between `weight` and `hindfoot_length` 
...
# Scatterplot between `weight` and `hindfoot_length` 
ggplot(data = surveys, 
       mapping = aes(x = weight, y = hindfoot_length, alpha = hindfoot_length)) +
  geom_point()
```
...
ggplot(data = surveys, 
  ...
  labs(x = "Weight of Animals (grams)",
       y = "Length of Hindfoot (mm)",
       title = "Length of Hindfoot by Weight of Animal Species") + 
  geom_point() +
  facet_wrap(~ species)
```
...
ggplot(data = surveys, 
  ...
  labs(x = "Weight of Animals (grams)", 
       y = " ",
       subtitle = "Length of Hindfoot (mm)",
       title = "Length of Hindfoot by Weight of Animal Species") + 
  geom_point() +
  facet_wrap(~ species)
```
...
# Boxplot side-by-side, for the distribution of weight within each species
...
# Boxplot - Add points to the plot
ggplot(data = surveys, aes(x = species, y = weight)) +
  geom_boxplot(position = position_dodge2()) + 
  geom_point()
```
...
# Boxplot - Remove points and add jitter
ggplot(data = surveys, aes(x = species, y = weight)) +
  geom_boxplot(position = position_dodge2()) + 
  geom_jitter()
...
#| label: boxplot-jitter-color

# Boxplot - Add color and transparency to the plot 
ggplot(data = surveys, aes(x = species, y = weight)) +
  geom_boxplot(position = position_dodge2()) + 
  geom_jitter(color = "springgreen4", alpha = 0.8)
...
```{r fig.height = 5.5, fig.width = 6}
#| label: boxplot-jitter-outliers

# Boxplot - Remove outliers from being plotter by `geom_boxplot`
ggplot(data = surveys, aes(x = species, y = weight)) +
  geom_boxplot(position = position_dodge2(), outliers = FALSE) + 
  geom_jitter(color = "springgreen4", alpha = 0.8)
...
```{r fig.height = 5.5, fig.width = 6}
#| label: boxplot-labels

# Boxplot - Add labels to the plots
ggplot(data = surveys, aes(x = species, y = weight)) +
  geom_boxplot(position = position_dodge2(), outliers = FALSE) + 
  geom_jitter(color = "springgreen4", alpha = 0.8) + 
  labs(x = "Species of Animals",
       y = "Weight of Animals (grams)", 
       title = "Animal Species by Weight") + 
...
```{r fig.height = 5.5, fig.width = 6}
#| label: boxplot-rotated

# Boxplot - Flip the orientation of the plot
ggplot(data = surveys, aes(x = species, y = weight)) +
  geom_boxplot(position = position_dodge2(), outliers = FALSE) + 
  geom_jitter(color = "springgreen4", alpha = 0.8) + 
  labs(x = "Species of Animals",
